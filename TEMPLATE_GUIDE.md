...
`public/images/`의 placeholder 파일을 후보자별 이미지로 교체하거나, `assets`의 경로를 새 파일명으로 바꿉니다.

- PC 히어로: `hero-wide.svg`
- 모바일 히어로: `hero-mobile.svg`
- 공약 이미지: `policy-visual.svg`
- 지도 이미지: `map-visual.svg`
- 카카오 공유 이미지: `share-kakao.svg`
- 문자/정사각 공유 이미지: `share-message.svg`
